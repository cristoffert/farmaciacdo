...
@section('contenido')
                    ...
                    <form id="form">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="" placeholder="nombre del vendedor" onchange="loadDatas();">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="title" id="txtName"></h5>
                </div>
                <div class="card-body">
                    <br>
                    <div>
                        <table class="table table-striped" cellspacing="0" width="100%" id="tablaDetalles">
...
@section('scripts')
                ...
                source: function(request, response) {
                    $.ajax({
                        ...
                        success: function(data) {
                            if( data.status ) {
                                if( data.data[0].id != "undefined" || data.data[0].id != null ) $('#vendedor_id').val(data.data[0].id);
    ...
    <script>
        //armas datatable de zonas y rutas
        function changeToDataTable()
        {
            $('#tablaDetalles').DataTable({
                ...
                "language": {
                    ...
                    "lengthMenu": "Mostrar _MENU_ vendedores por Página",
...
//                                image: 'data:image/png;base64,'
                        ...
                        "messageTop": function () {
                            return "<h6 class='title text-center'>Vendedor</h6>";
                        },
                        //"className": "red"
                    },
                    {
        ...
        function loadRutas( origin ) {
            var src = "{{ route('zona.search.rutas.json') }}";
                ...
                success: function(data) {
                    ...
                    if( data.id === 'I' ) {
                        ...
                        $.each(data, function (key, value) {
                            ...
                            if( value.is_checked ) checkRutas.setAttribute('checked',true);
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status) {
                        ...
                        $('#txtName').text('Rutas del Vendedor : '+$('#name').val().toUpperCase() );
                        $('#tablaDetalles').append("<tbody id='datas_rutas'></tbody>");
                        $.each(data.rutas, function (index,value) {
                            $('#datas_rutas').append("<tr id='row'+idenx><td class='text-center'>"+value.zona.nombre+"</td><td class='text-center'>"+value.nombre+"</td></tr>");
                        });
                    }
                    else {
                        alert(data.msg);
