    ...
    <script>
        function Delete( nameProduct , idDel ) {
			...
			$.confirm({
				...
				content: 'Seguro(a) que deseas eliminar el descripcion de Iva ' + nameProduct + '. <br> Click Aceptar or Cancelar',
					...
					'confirm': {
						...
						action: function () {
							$.confirm({
								theme: 'supervan',
								title: 'Estas Seguro ?',
								content: 'Una vez eliminado debes volver a crear la descripcion de Iva',
								icon: 'fa fa-warning',
								animation: 'scale',
								animationBounce: 2.5,
								closeAnimation: 'zoom',
        ...
        $(document).ready(function() {
            $('#tableTiposMovimientos').DataTable({
                "language": {
                    ...
                    "lengthMenu": "Mostrar _MENU_ Descripciones de Ivas por Página",
