        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-center">
                    <h5 class="title text-center">Establecer Fecha para Realizar el Cargue</h5>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-3">
                       <input type="date" class="form-control" name="fecha_inicio" id="fecha_inicio" value="{{ old('fecha_inicio',date("Y-m-d")) }}">
                    </div>
                    <div class="col-md-2 text-right">
                        <label for="fecha_final" class="control-label">Fecha Final:</label>
                    </div>
                    <div class="col-md-3">
                        <input type="date" class="form-control" name="fecha_final" id="fecha_final" value="{{ old('fecha_final',date("Y-m-d")) }}">
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <button class="btn btn-round btn-info" id="btn_nuevo">Nuevo Cargue</button>
                    </div>
                    <div class="col-md-4 text-center">
                        <button class="btn btn-round btn-info" id="btn_guardar">Guardar Cargue</button>
                    </div>
                </div>
                <div id="contenido-cargue">
...
@section('scripts')
    ...
    <script>
        function llenarDetalles(ruta,response, index)
        {
            $('#tablaDetalles'+index).DataTable({
                "destroy": true,
                "data": response,
                "columns":[
...
//                                image: 'data:image/png;base64,'
                        ...
                        "messageTop": function () {
                            return "<h6 class='title text-center'>"+ruta+"</h6>";
                        },
                        //"className": "red"
                    },
                    {
        ...
        function llenar(response, index)
        {
            $('#tablaVentas'+index).DataTable({
                "destroy": true,
                "data": response,
                "columns":[
                    {"data":"name"},
...
//
        $('#btn_guardar').click( function() {
            var cantidadRutas = document.getElementById('contenido-cargue').childNodes.length;
            var filas = $("#tablaVentas0 tr").length;
            if( filas <= 1 ) {
                ...
                var venta_ids = [];
                for( var j = 0 ; j < cantidadRutas-1 ; j++ ) {
                    var filas = $("#tablaVentas"+j+" tr").length;
                    console.log('filas tabla '+(j+1)+' igual a '+filas);
                    for (var i=1;i < filas; i++) {
                        venta_ids.push(document.getElementById('tablaVentas'+j).rows[ i ].cells[ 1 ].innerHTML);
                    }
                }
...
//
        $('#btn_filtrar').click( function() {
            ...
            $.ajax({
                ...
                success: function( data ){
                    $.each(data.rutas, function(index, value){
                        var newDiv = document.createElement("div");
                        newDiv.setAttribute('id','control'+index);
                        newDiv.setAttribute('class','text-center');
                        newDiv.innerHTML = '<h6 class="title">'+ value.nombre +'</h6>';
                        var tablaDetalles   = document.createElement("table");
                        tablaDetalles.setAttribute('id','tablaDetalles'+index);
                        tablaDetalles.setAttribute('class','table');
                        tablaDetalles.setAttribute('cellspacing','0');
                        tablaDetalles.setAttribute('width','100%');
                        var tblHeadDetalle = document.createElement("thead");
                        tblHeadDetalle.setAttribute('class','text-primary');
                        tblHeadDetalle.innerHTML = "<tr><td>Nombre Producto</td><td>Marca</td><td>Tamaño Envase</td><td>Cantidad</td></tr>";
                        tablaDetalles.appendChild(tblHeadDetalle);
                        var tblBodyDetalle = document.createElement("tbody");
                        tablaDetalles.appendChild(tblBodyDetalle);
                        var tabla   = document.createElement("table");
                        tabla.setAttribute('id','tablaVentas'+index);
                        tabla.setAttribute('class','display nowrap');
                        tabla.setAttribute('cellspacing','0');
                        tabla.setAttribute('width','100%');
                        var tblHead = document.createElement("thead");
                        tblHead.setAttribute('class','text-primary');
                        tblHead.innerHTML = "<tr><td>Nombre</td><td># Factura</td><td>Fecha Entrega</td><td>Estado</td><td>Total</td><td>Accion</td></tr>";
                        tabla.appendChild(tblHead);
                        var tblBody = document.createElement("tbody");
                        tabla.appendChild(tblBody);
                        newDiv.appendChild(tablaDetalles);
                        newDiv.appendChild(tabla);
                        document.getElementById("contenido-cargue").appendChild(newDiv);
                        document.querySelector('p').innerHTML = '<br>';
                        llenarDetalles(value.nombre , data.detalles[index],index );
                        llenar( data.ventas[index],index );
                    });
                }
            });
        })
