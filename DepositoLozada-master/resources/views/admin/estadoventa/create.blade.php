    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="title text-center">Crear Nuevo Estado de Venta</h5>
            </div>
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ url('/estadoventa') }}">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <div class="text-center">
                        <button class="btn btn-warning">Registrar Estado de Venta</button>
