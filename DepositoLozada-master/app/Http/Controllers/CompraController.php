 ...
 // dd($id);
    ...
    //    dd($ObtenerPrecio);
        ...
        public function store( Request $request ) {
            ...
            $compra -> dococ = $request->input('dococ');
            $compra -> posicion = $request->input('posicion');
            $compra -> escaneo = $request->input('escaneo');
            $compra -> lote = $request->input('lote');
            $compra -> vencimiento = $request->input('vencimiento');
            $compra -> cantidadrecepcion = $request -> input('cantidadrecepcion');
            ...
            $idCompra = Session::get('IdCompra');
            return redirect('/ordencompra') -> with( compact( 'notification' ) );
        }
