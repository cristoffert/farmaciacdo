...
function AbrirModalCanasta()
{
  ...
  var ruta2 = '/compra/ConsultarCanastaEditar/'+ tipopaca;
      ...
      formSubmit: {
          ...
          action: function () 
          {
            ...
            if(notificacion !="")
            {
              ...
              var ruta2 = '/compra/AgregarCanastaEditar/';
...
$("#tipopaca").change(function () {
  // alert($(this).val());
    ...
    $.ajax({
      ...
      type: "GET",
      url: ruta+"/compra/MostrarProductoEditar/"+ $(this).val(),
...
//listar contenido
        $("#marca").change(function () {
          ...
          $.ajax({
            ...
            type: "GET",
            url: ruta+"/compra/MostrarTipoContenidoEditar/"+ $(this).val(),
...
//////listar Tipo Pacas
        ...
        // alert($(this).val());
          ...
          $.ajax({
            ...
            type: "Get",
            url: ruta+"/compra/MostrarTipoPacaEditar/"+ $(this).val(),
