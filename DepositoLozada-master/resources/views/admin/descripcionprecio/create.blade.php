    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="title">Crear Nueva Descripcion para Precios</h5>
            </div>
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ url('/descripcionprecio') }}">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <div class="text-center">
                        <button class="btn btn-warning">Registrar Descripcion de Precio</button>
                        <a href="{{ url('/descripcionprecio') }}" class="btn btn-default">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
