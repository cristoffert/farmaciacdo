...
@section('titulo-contenido','Orden de Compra')
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="form-group">
                    <input type="number" class="form-control" name='search' placeholder="Buscar Orden de Compra"/>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table" cellspacing="0" id="tableOrdenCompra">
                        ...
                        <tbody>
                            ...
                            @foreach( $ordenesdecompra as $ekpo )
                         
                            <?php
                            $suma=$ekpo->MENGE+$ekpo->WEMNG;
