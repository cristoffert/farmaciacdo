...
@section('titulo-contenido','Tipos de Contenido')
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="title">Crear Nuevo Tipos de Contenido</h5>
            </div>
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ url('/tipocontenido') }}">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <div class="text-center">
                        <button class="btn btn-warning">Registrar Tipo de Contenido</button>
