        ...
        <div class="card">
            ...
            <div class="card-body" onload="mapa.initMap()">
                ...
                <div class="row justify-content-center">
                    <a class="btn btn-info" href="{{ url('/vendedor/ruta/'.Auth::user()->id.'/rutas_por_vendedor') }}">Regresar</a>
                </div>
                <div id="right-panel">
...
@section('scripts')
 <!--  Google Maps Plugin    -->
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDefNeRosluKYv5E5VXVdSxKr07FyNQHh8&callback=initMap" async defer></script>
