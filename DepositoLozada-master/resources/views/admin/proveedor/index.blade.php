    ...
    <script>
        function Delete( nameProduct , idDel ) {
			...
			$.confirm({
				...
				content: 'Seguro(a) que deseas eliminar el proveedor' + nameProduct + '. <br> Click Aceptar or Cancelar',
					...
					'confirm': {
						...
						action: function () {
							$.confirm({
								theme: 'supervan',
								title: 'Estas Seguro ?',
								content: 'Una vez eliminado debes volver a crear el proveedor',
								icon: 'fa fa-warning',
								animation: 'scale',
								animationBounce: 2.5,
								closeAnimation: 'zoom',
        ...
        $(document).ready(function() {
            $('#tableTiposMovimientos').DataTable({
                "language": {
                    ...
                    "emptyTable": "No hay proveedors registrados , click en el boton <b>Nuevo proveedor</b> para agregar uno nuevo",
                    "paginate": {
                        "first": "Primero",
                        "last": "Ultimo",
                        "previous": "Anterior",
                    ...
                    "lengthMenu": "Mostrar _MENU_ proveedors por Página",
