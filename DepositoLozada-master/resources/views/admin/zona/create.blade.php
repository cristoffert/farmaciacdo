...
@section('titulo-contenido','Zonas')
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5 class="title">Crear Nueva Zona</h5>
            </div>
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ url('/zona') }}">
                    {{ csrf_field() }}
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="fk_bodega">
                                        ...
                                        @foreach ( $bodegas as $bodega )
                                            <option class="form-control" value="{{ $bodega->id }}">{{ $bodega->nombre }}</option>
                                        @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        <button class="btn btn-warning">Registrar Zona</button>
